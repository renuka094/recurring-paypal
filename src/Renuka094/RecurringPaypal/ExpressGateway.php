...
class ExpressGateway extends ProGateway
{
    ...
    public function authorize(array $parameters = array())
    {
        ...
        return $this->createRequest('\Renuka094\RecurringPaypal\Message\ExpressAuthorizeRequest', $parameters);

    }

    public function completeAuthorize(array $parameters = array())
    {
        return $this->createRequest('\Renuka094\RecurringPaypal\Message\ExpressCompleteAuthorizeRequest', $parameters);
    }
    ...
    public function completePurchase(array $parameters = array())
    {
        ...
        return $this->createRequest('\Renuka094\RecurringPaypal\Message\ExpressCompletePurchaseRequest', $parameters);
    }

    public function void(array $parameters = array())
    {
        return $this->createRequest('\Renuka094\RecurringPaypal\Message\ExpressVoidRequest', $parameters);
    }

    public function fetchCheckout(array $parameters = array())
    {
        return $this->createRequest('\Renuka094\RecurringPaypal\Message\ExpressFetchCheckoutRequest', $parameters);
    }
    public function getCountry()
    {
        return strtoupper($this->getParameter('country'));
    }
